...
Study a source to extract portable design intelligence. Record evidence first, infer rules second, and transform the rules for the target project.

## Acceptable inputs

- HTML/CSS/JavaScript source;
- a local running page;
- screenshots or a contact sheet;
- a video or screen recording;
- a live URL;
- several references that share a quality the user likes.

Respect source licenses. Treat unknown, restrictive, or per-artifact licenses as study-only. Recreate algorithms from public technical knowledge and original reasoning. Keep final code, copy, assets, and visual identity original unless the license and task explicitly allow reuse.

## Pass 1 — Observe the frames
...
```text
SILHOUETTE    dominant mass, void, and crop
DENSITY       where detail gathers and falls away
DEPTH         layer count and cues
...
## Pass 2 — Infer the rules

Extract sentences that can survive a new subject and renderer:

- “A tiny high-detail specimen gains importance through extreme negative space.”
...
## Pass 3 — Build the source fingerprint

Record:

```text
ARTIFACT     environment / specimen / instrument / document / event / sample
ARCHETYPE    monument / field / plate / threshold / topology / sequence
SCALE        miniature / human / architectural / planetary
DENSITY      sparse / focal / graded / saturated
MATERIAL     primary substance + contradiction
TEMPO        still / drifting / pulsed / staged / reactive
RESPONSE     ambient / probe / tool / scroll / data
TYPE ROLE    absent / label / frame / texture / subject
...
| Source principle | Target evidence | Transformation | Implementation consequence |
| --- | --- | --- | --- |
...
Avoid labels such as “futuristic,” “organic,” or “editorial” without describing the visible rules that create the impression.
